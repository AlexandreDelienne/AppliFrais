...
/*permet de determiner tous les mois ou l'identitifié a des fiches de frais */

/*function obtenirReqMoisFicheFrais($idUser) {
$requete = "select mois from FicheFrais where idVisiteur='$idUser';";
}*/

function listeUtilisateur () {
$requete ="select * from Visiteur where typeVisiteur=1";
return $requete;
}            
